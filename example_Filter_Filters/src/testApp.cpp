...
//    tone = LPF12().input(tone).Q(100).cutoff(frequency*2 + SawtoothWave().freq(30) * 1.5 * frequency);
//    tone = LPF12().input(tone).Q(100).cutoff(frequency*2 + SquareWave().freq(30) * 1.5 * frequency);
    tone = LPF12().input(tone).Q(100).cutoff(frequency*2 + RectWave().freq(30) * 1.5 * frequency);
